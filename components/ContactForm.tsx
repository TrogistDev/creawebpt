    ...
    <section id="contato">
      ...
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-3">
            <Label className="text-[#94A3B8] text-sm uppercase tracking-wide font-semibold ml-1">
              Estado do Conteúdo (Texto/Imagens) <span className="text-[#ff00e2]">*</span>
            </Label>
            <div className="relative">
              <Select name="conteudo" required>
                ...
                <SelectContent className="bg-[#1A1A1B] border border-[#373dff]/20 text-white rounded-xl">
                  <SelectItem value="pronto" className="py-3 text-lg focus:bg-[#373dff]/20">Tenho tudo pronto</SelectItem>
                  <SelectItem value="parcial" className="py-3 text-lg focus:bg-[#373dff]/20">Tenho algumas coisas</SelectItem>
                  <SelectItem value="nada" className="py-3 text-lg focus:bg-[#373dff]/20">Não tenho nada ainda</SelectItem>
                  <SelectItem value="ajuda" className="py-3 text-lg focus:bg-[#373dff]/20">Preciso que criem por mim</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <Select name="decisao">
                ...
                <SelectContent className="bg-[#1A1A1B] border border-[#373dff]/20 text-white rounded-xl">
                  <SelectItem value="unico" className="py-3 text-lg focus:bg-[#373dff]/20">Decido sozinho(a)</SelectItem>
                  <SelectItem value="socios" className="py-3 text-lg focus:bg-[#373dff]/20">Decido com sócios</SelectItem>
                  <SelectItem value="diretoria" className="py-3 text-lg focus:bg-[#373dff]/20">Necessita aprovação superior</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <Label htmlFor="referencias" className="text-[#94A3B8] text-sm uppercase tracking-wide font-semibold ml-1">
