...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:max-w-md bg-zinc-900 border border-zinc-800 p-6 rounded-2xl shadow-2xl z-[9999]">
      <h3 className="text-white font-bold mb-2">🍪 Cookies na Crea Web</h3>
      <p className="text-zinc-400 text-sm mb-4">
        Usamos cookies para melhorar a sua experiência e medir resultados de anúncios (Google Ads). 
        Aceita o rastreio para nos ajudar a crescer?
      </p>
